...
namespace NeukonstChecklistWebHTML.Controllers
{
    public class UsersController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Initialen,Passwort,Admin")] User user)
        {
            if (LoggedInUser.Admin == false)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Initialen,Passwort,Admin")] User user)
        {
            if (LoggedInUser.Admin == false)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
